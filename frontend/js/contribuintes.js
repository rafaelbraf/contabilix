...
async function getContribuintes() {
    ...
    let mensagemErro;
    const url = 'http://54.160.250.66:8081/api/contribuintes/usuario/' + usuario.id;
...
async function inserirContribuintes(contribuintes) {
    let mensagemErro;
    const url = 'http://54.160.250.66:8081/api/contribuintes/lista';
...
async function getImpostosDeRendasDoContribuinte(contribuinte)  {
    ...
    const url = 'http://54.160.250.66:8081/api/impostorenda/contribuinte/' + contribuinteId;
