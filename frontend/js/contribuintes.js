...
async function getContribuintes() {
    ...
    let mensagemErro;
    const url = 'http://localhost:8081/api/contribuintes/usuario/' + usuario.id;
...
async function inserirContribuintes(contribuintes) {
    let mensagemErro;
    const url = 'http://localhost:8081/api/contribuintes/lista';
...
async function getImpostosDeRendasDoContribuinte(contribuinte)  {
    ...
    const url = 'http://localhost:8081/api/impostorenda/contribuinte/' + contribuinteId;
